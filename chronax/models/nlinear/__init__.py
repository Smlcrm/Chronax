"""NLinear forecasting model (univariate, JAX/Flax-NNX port of neuralforecast.NLinear)."""
import flax

if not flax.__version__.startswith("0.10"):
    raise ImportError(
        f"chronax.models.NLinear is pinned to flax==0.10.x; got flax {flax.__version__}. "
